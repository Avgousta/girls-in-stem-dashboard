...
- [x] **Misplaced duplicate files** — `components/app/` and `components/components/` were empty; nothing to clean.
...
| T5 | `any` used heavily in TypeScript — interfaces incomplete | ⚠️ Improved — typed interfaces added to projects/[id]/page.tsx + sponsor/page.tsx, ~40 casts removed |
